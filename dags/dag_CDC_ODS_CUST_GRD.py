...
var_text = Variable.get('VAR_dag_CDC_ODS_CUST_GRD')
...
with DAG(
    ...
    task_CU_ITNT_CUST_GRD_1_INF = PythonOperator(
        task_id="task_CU_ITNT_CUST_GRD_1_INF",
        python_callable=ora_to_snow_merge,
        op_args=["conn_oracle_main", "conn_snow_load", var_dict['task_CU_ITNT_CUST_GRD_1_INF']['ETL_TABLE'],
                 var_dict['task_CU_ITNT_CUST_GRD_1_INF']['LOAD_TABLE'],
                 var_dict['task_CU_ITNT_CUST_GRD_1_INF']['COLUMNS'], var_dict['task_CU_ITNT_CUST_GRD_1_INF']['PK_COLUMNS'],
                 CONDITION_QEURY2],
    ...
    task_CU_ITNT_CUST_GRD_2_INF = PythonOperator(
        task_id="task_CU_ITNT_CUST_GRD_2_INF",
        python_callable=ora_to_snow_merge,
        op_args=["conn_oracle_main", "conn_snow_load", var_dict['task_CU_ITNT_CUST_GRD_2_INF']['ETL_TABLE'],
                 var_dict['task_CU_ITNT_CUST_GRD_2_INF']['LOAD_TABLE'],
                 var_dict['task_CU_ITNT_CUST_GRD_2_INF']['COLUMNS'], var_dict['task_CU_ITNT_CUST_GRD_2_INF']['PK_COLUMNS'],
                 CONDITION_QEURY2],
        trigger_rule="all_done",
        provide_context=True,
        on_failure_callback=notify_api_on_error
    ...
    task_ETL_SCHEDULE_c_01 >> [task_CU_ITNT_CUST_GRD_1_INF , task_CU_ITNT_CUST_GRD_2_INF]
