...
def log_etl_completion(**kwargs):
    ...
    print(f"*** {complete_time} : CDC_MART_CAMP 프로시져 실행 완료 **")
...
with DAG(
    ...
    task_SP_RCU_CUST_PRFR_ITEM_L_CSF_INF = PythonOperator(
        ...
        op_args=["SP_RCU_CUST_PRFR_ITEM_L_CSF_INF", p_start, p_end],
    ...
    task_SP_RCU_CUST_BUY_CHRTR_INF = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_RCU_CUST_BUY_CHRTR_INF", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_BCU_CAMP_TRGT_CUST_MST = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_BCU_CAMP_TRGT_CUST_MST", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_RCU_CRM_DLU_KPI_FCT = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_RCU_CRM_DLU_KPI_FCT", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_CP_SMR_MST = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_CP_SMR_MST", p_start, p_end],
        trigger_rule="all_done"
    )
