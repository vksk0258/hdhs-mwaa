...
with DAG(
    ...
    task_SP_RPD_DPRCH_EUPDN_INF = PythonOperator(
        ...
        op_args=["SP_RPD_DPRCH_EUPDN_INF", p_start, p_end],
    ...
    task_SP_RPD_DPRCH_ITEM_STCK_INF = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_RPD_DPRCH_ITEM_STCK_INF", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_PPD_OSHP_TKTM_DYS_FCT = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_PPD_OSHP_TKTM_DYS_FCT", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_PAR_INSU_ARLT_DLU_FCT = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_PAR_INSU_ARLT_DLU_FCT", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_PAR_SO_ARLT_DLU_FCT = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_PAR_SO_ARLT_DLU_FCT", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_RIA_ITEM_ANAL_FCT = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_RIA_ITEM_ANAL_FCT", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_PCU_CUST_ANAL_FCT = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_PCU_CUST_ANAL_FCT", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_PCU_CUST_ANAL_FCT_01 = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_PCU_CUST_ANAL_FCT_01", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_PCU_CUST_ANAL_FCT_02 = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_PCU_CUST_ANAL_FCT_02", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_PMA_COPN_ANAL_DLU_FCT_01 = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_PMA_COPN_ANAL_DLU_FCT_01", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_PMA_COPN_ANAL_DLU_FCT_02 = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_PMA_COPN_ANAL_DLU_FCT_02", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_RIA_ITEM_ANAL_FCT_02 = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_RIA_ITEM_ANAL_FCT_02", p_start, p_end],
        trigger_rule="all_done"
    )
    ...
    task_SP_PMA_EVNT_ANAL_DLU_FCT = PythonOperator(
        ...
        python_callable=execute_procedure,
        op_args=["SP_PMA_EVNT_ANAL_DLU_FCT", p_start, p_end],
        trigger_rule="all_done"
    )
