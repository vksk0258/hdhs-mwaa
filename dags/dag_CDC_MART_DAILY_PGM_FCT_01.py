...
with DAG(
    ...
    task_SP_PAR_SHPL_ORD_ARLT_DLU_FCT = PythonOperator(
        task_id="task_SP_PAR_SHPL_ORD_ARLT_DLU_FCT",
        python_callable=execute_procedure,
        op_args=["SP_PAR_SHPL_ORD_ARLT_DLU_FCT", p_start, p_end, 'conn_snowflake_etl'],
        trigger_rule="all_done"
    )
