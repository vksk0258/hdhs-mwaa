...
with DAG(
    dag_id="dag_WW01_FRI_0630_WEEKLY_01",
    ...
    trigger_dag_CDC_MART_WEEKLY_02 = TriggerDagRunOperator(
        task_id='trigger_dag_CDC_MART_WEEKLY_02',
        trigger_dag_id='dag_CDC_MART_WEEKLY_02',
    ...
    task_ETL_SCHEDULE_c_01 >> trigger_dag_CDC_MART_WEEKLY_02