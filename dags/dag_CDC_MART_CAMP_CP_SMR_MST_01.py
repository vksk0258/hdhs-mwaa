...
def execute_procedure(procedure_name, p_start, p_end,conn_id,**kwargs):
    """
    ...
    try:
        with snowflake_hook.get_conn() as conn:
            with conn.cursor() as cur:
                ...
                select_query = f"""
                                        SELECT * FROM CAMP_API_DB.DW_ETC.JOB_RESULT
...
with DAG(
    ...
    tags=["현대홈쇼핑","dag_DD01_1200_CP_SMR_MST_01", "Scheduled"]
) as dag:
