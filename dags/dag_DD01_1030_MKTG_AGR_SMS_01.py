...
with DAG(
    ...
    trigger_dag_CDC_MART_MKTG_SMS_01 = TriggerDagRunOperator(
        task_id='trigger_dag_CDC_MART_MKTG_SMS_01',
        trigger_dag_id='dag_CDC_MART_MKTG_SMS_01',
    ...
    task_ETL_SCHEDULE_c_01 >> trigger_dag_CDC_MART_MKTG_SMS_01