...
with DAG(
        ...
        tags=["현대홈쇼핑","SWRT", "ODS"]  # DAG에 붙일 태그
) as dag:
    ...
    task_HES_EXP_SWRT_DTL >> task_HES_EXP_SWRT_ETC_DTL >> task_HES_EXP_SWRT_MLB_DTL >> task_HES_EXP_SWRT_ONLN_DTL >> task_HES_EXP_SWRT_ONLN_ETC_DTL
