...
def log_etl_completion(**kwargs):
    ...
    print(f"*** {complete_time} : CDC_MART_MART_DS_01 프로시져 실행 완료 **")

with DAG(
    dag_id="dag_CDC_MART_DS_01",
    schedule_interval=None,
    tags=["현대홈쇼핑"]
) as dag:
    task_SP_RPD_DLV_TRC_DTL = PythonOperator(
        task_id="task_SP_RPD_DLV_TRC_DTL",
        python_callable=execute_procedure,
        op_args=["SP_RPD_DLV_TRC_DTL", p_start, p_end],
    ...
    task_SP_RPD_DLV_TRC_DTL >> task_ETL_DAILY_LOG